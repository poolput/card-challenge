...
class Twig_Node_Module extends Twig_Node
{
    ...
    protected function compileTemplate(Twig_Compiler $compiler)
    {
        ...
        if (count($this->getNode('blocks')) || count($this->getNode('traits')) || null === $this->getNode('parent') || $this->getNode('parent') instanceof Twig_Node_Expression_Constant || count($this->getNode('constructor_start')) || count($this->getNode('constructor_end'))) {
    ...
    protected function compileClassHeader(Twig_Compiler $compiler)
    {
        ...
        write('/* ' . str_replace('*/', '* /', $this->getAttribute('filename')) . " */\n")
            ...
            ->getTemplateClass($this->getAttribute('filename'), $this->getAttribute('index')))
    ...
    {
        $compiler->subcompile($this->getNode('class_end'))
            ->outdent()
            ->write("}\n");
    }
