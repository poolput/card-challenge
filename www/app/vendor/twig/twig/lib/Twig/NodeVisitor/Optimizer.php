...
class Twig_NodeVisitor_Optimizer extends Twig_BaseNodeVisitor
{
    ...
    protected function enterOptimizeFor(Twig_NodeInterface $node, Twig_Environment $env)
    {
        ...
        elseif ($node instanceof Twig_Node_Expression_Function && 'include' === $node->getAttribute('name') && (! $node->getNode('arguments')->hasNode('with_context') || false !== $node->getNode('arguments')
