...
class Twig_Extension_Core extends Twig_Extension
{
     ...
     * @param string $dateIntervalFormat
 ...
 *            An array or an ArrayAccess instance
 * @param int $position
 *            The cycle position
 *            
 ...
 * @param Traversable|array|int|string $values
 ...
 * @param Twig_Environment $env
 *            A Twig_Environment instance
 * @param array|Traversable|string $item
