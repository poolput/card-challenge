...
class Twig_Environment
{
    ...
    public function loadTemplate($name, $index = null)
    {
        ...
        if (! class_exists($cls, false)) {
            ...
            if (! class_exists($cls, false)) {
                $content = $this->compileSource($this->getLoader()
                    ->getSource($name), $name);
     ...
     *
     * @param string|Twig_Template|array $names
     ...
     * Registers a Filter.
     *
     * @param string|Twig_SimpleFilter $name
     ...
     * Registers a Test.
     *
     * @param string|Twig_SimpleTest $name
     *            The test name or a Twig_SimpleTest instance
     * @param Twig_TestInterface|Twig_SimpleTest $test
     ...
     *
     * @param string|Twig_SimpleFunction $name
