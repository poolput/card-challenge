...
class Twig_Tests_LexerTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testNameLabelForTag()
    {
        ...
        $this->assertSame('§', $stream->expect(Twig_Token::NAME_TYPE)
            ->getValue());
    }
    ...
    public function testLineDirective()
    {
        ...
        // foo\nbar\n
        $this->assertSame(1, $stream->expect(Twig_Token::TEXT_TYPE)
            ->getLine());
        // \n (after {% line %})
        $this->assertSame(10, $stream->expect(Twig_Token::TEXT_TYPE)
            ->getLine());
        // {{
        $this->assertSame(11, $stream->expect(Twig_Token::VAR_START_TYPE)
            ->getLine());
        // baz
        $this->assertSame(12, $stream->expect(Twig_Token::NAME_TYPE)
            ->getLine());
    }
    ...
    public function testLineDirectiveInline()
    {
        ...
        $this->assertSame(1, $stream->expect(Twig_Token::TEXT_TYPE)
            ->getLine());
        // {{
        $this->assertSame(10, $stream->expect(Twig_Token::VAR_START_TYPE)
            ->getLine());
        // baz
        $this->assertSame(11, $stream->expect(Twig_Token::NAME_TYPE)
            ->getLine());
    }
