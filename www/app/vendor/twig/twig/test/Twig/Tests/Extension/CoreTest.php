...
class Twig_Tests_Extension_CoreTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testRandomFunctionReturnsAsIs()
    {
        ...
        $this->assertSame('', twig_random(new Twig_Environment($this->getMock('Twig_LoaderInterface'), array(
            'charset' => null
        )), ''));
    ...
    public function testRandomFunctionOnNonUTF8String()
    {
        ...
        for ($i = 0; $i < 30; ++ $i) {
            ...
            $this->assertTrue(in_array(twig_convert_encoding($rand, 'UTF-8', 'ISO-8859-1'), array(
                'Ä',
                'é'
            ), true));
        }
    ...
    public function testTwigFirst()
    {
        ...
        $this->assertEquals(1, twig_first($twig, array(
            1,
            2,
            3
        )));
    ...
    public function testTwigLast()
    {
        ...
        $this->assertEquals(3, twig_last($twig, array(
            1,
            2,
            3
        )));
