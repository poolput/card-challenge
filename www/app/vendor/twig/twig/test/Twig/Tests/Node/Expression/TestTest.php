...
class Twig_Tests_Node_Expression_TestTest extends Twig_Test_NodeTestCase
{
    ...
    public function getTests()
    {
        ...
        $environment->addTest(new Twig_SimpleTest('barbar', 'twig_tests_test_barbar', array(
            'is_variadic' => true,
            'need_context' => true
        )));
        ...
        if (PHP_VERSION_ID >= 50300) {
            $node = $this->createTest(new Twig_Node_Expression_Constant('foo', 1), 'anonymous', array(
        ...
        $tests[] = array(
            $node,
            'twig_tests_test_barbar("abc", null, null, array("foo" => "bar"))',
            $environment
        );
        ...
        $tests[] = array(
            $node,
            'twig_tests_test_barbar("abc", null, "bar")',
            $environment
        );
        ...
        $tests[] = array(
            $node,
            'twig_tests_test_barbar("abc", "1", "2", array(0 => "3", "foo" => "bar"))',
            $environment
        );
