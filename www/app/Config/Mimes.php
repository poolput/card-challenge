...
class Mimes
{
     ...
     *
     * @param string $type
     * @param string $proposed_extension
     *            - default extension (in case there is more than one with the same mime type)
     *            
    ...
    public static function guessExtensionFromType(string $type, ?string $proposed_extension = null)
    {
        ...
        if (! is_null($proposed_extension) && array_key_exists($proposed_extension, static::$mimes) && in_array($type, is_string(static::$mimes[$proposed_extension]) ? [
