...
class App extends BaseConfig
{
     ...
     * |
     */
    public $baseURL = 'http://18.141.187.15/';
     ...
     * |--------------------------------------------------------------------------
     * |
     * | This config for change color meaning for heat
     * | eg: min=100, max=200
     * | if min < 100 is red and sometime if min < 100 is green
     * | to be config here
     */
    public $densityLessthan = '#D1321E';

    public $densityBetween = '#F3DC18';

    public $densityGreaterthan = '#49B261';
