...
class __TwigTemplate_dbff4e5452d32d3c06b45092b09334b12130dbbb16e9efadf4a688ef28608c21 extends Twig_Template
{
...
\t</div>
    ...
    {
        return array (  69 => 14,  65 => 13,  59 => 12,  53 => 11,  49 => 9,  40 => 7,  31 => 5,  29 => 4,  19 => 1,);
    }
}
...
/* 			<span class="item-order">*/
/* 				<a href="javascript:void(0);" data-id="{{ group_id }}" data-level="{{ params.owner }}" class="bar-item add-owner" aria-label="Move up" title="Insert this level"><i class="fa fa-plus-square-o"></i></a>  */
/* 				<a href="javascript:void(0);" data-id="{{ group_id }}" data-level="{{ params.child }}" class="bar-item add-child" aria-label="Move down" title="Insert sub level"><i class="fa fa-plus-square"></i></a>*/
...
/* 				<a href="javascript;" data-id="{{ group_id }}" class="bar-item add-branch" aria-label="Move down" title="Mapping Branch" data-toggle="modal" data-target="#add-branch-Modal"><i class="fa fa-th-list"></i></a>*/
/* 			</span>*/
/* 		</span>*/
/* 	</div>*/
/*  */
