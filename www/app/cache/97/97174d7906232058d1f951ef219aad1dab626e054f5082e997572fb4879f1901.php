...
/* filter/criteria_comparison.twig */
class __TwigTemplate_73ae21938849eb7c35b5bda9da3c52472f34ffde9af79cf896536a777a86573e extends Twig_Template
{
...
\t<div id=\"btn-date-header-block\">
    ...
    \t\t<input autocomplete=\"off\" type=\"text\" disabled class=\"input-sm form-control date-start\" name=\"start\" value=\"";
        // line 13
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, "now", "Y-m-d"), "html", null, true);
        echo "\" > 
    \t\t<span class=\"input-to pt-2\">-</span> 
    \t\t<input autocomplete=\"off\" type=\"text\" disabled class=\"input-sm form-control date-end\" name=\"end\" value=\"";
        // line 15
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, "now", "Y-m-d"), "html", null, true);
        echo "\">
    \t</div>
...
\t\t\t\t\t\t\t\t\t\t\t<!-- 
    ...
    \t\t\t\t\t\t\t\t\t\t\t<span class=\"row col-md-12\" id=\"date-";
        // line 316
        ...
        echo "\">
    \t\t\t\t\t\t\t\t\t\t\t\t<input checked=\"\" type=\"checkbox\" name=\"option_compare_date[]\" value=\"";
        // line 317
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_date_modify_filter($this->env, "now", "-1 day"), "Y-m-d"), "html", null, true);
        echo "\"> 
    \t\t\t\t\t\t\t\t\t\t\t\t&nbsp;";
        ...
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_date_modify_filter($this->env, "now", "-1 day"), "Y-m-d"), "html", null, true);
        echo " &nbsp;
    \t\t\t\t\t\t\t\t\t\t\t\t<i class=\"fa fa-minus remove-compare-date\" data-id=\"date-";
        // line 319
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_date_modify_filter($this->env, "now", "-1 day"), "Y-m-d"), "html", null, true);
        echo "\"></i>
    \t\t\t\t\t\t\t\t\t\t\t</span>
...
\t\t\t\t\t\t\t\t\t<ul>";
    ...
    {
        return "filter/criteria_comparison.twig";
    }
    ...
    {
        return array (  753 => 133,  747 => 131,  744 => 129,  742 => 128,  739 => 125,  727 => 120,  713 => 118,  711 => 117,  707 => 116,  701 => 113,  689 => 111,  687 => 110,  681 => 107,  669 => 105,  665 => 104,  662 => 102,  660 => 101,  647 => 100,  634 => 379,  620 => 374,  611 => 372,  608 => 371,  604 => 370,  591 => 358,  581 => 356,  577 => 355,  544 => 324,  540 => 323,  536 => 322,  532 => 321,  527 => 319,  523 => 318,  519 => 317,  515 => 316,  457 => 260,  447 => 258,  443 => 257,  425 => 240,  415 => 238,  411 => 237,  408 => 235,  398 => 233,  394 => 232,  376 => 215,  366 => 213,  362 => 212,  359 => 210,  349 => 208,  345 => 207,  327 => 190,  317 => 188,  313 => 187,  310 => 185,  300 => 183,  296 => 182,  264 => 151,  258 => 148,  255 => 146,  253 => 145,  251 => 144,  241 => 141,  232 => 139,  229 => 138,  225 => 137,  222 => 135,  215 => 93,  208 => 90,  201 => 87,  184 => 83,  173 => 82,  171 => 81,  167 => 80,  164 => 79,  153 => 71,  135 => 68,  122 => 67,  118 => 66,  115 => 65,  111 => 64,  107 => 63,  100 => 59,  90 => 56,  85 => 55,  81 => 54,  40 => 15,  35 => 13,  25 => 6,  19 => 1,);
    }
}
