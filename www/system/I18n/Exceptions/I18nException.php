...
class I18nException extends FrameworkException implements ExceptionInterface
{
    ...
    {
        return new static(lang('Time.invalidMonth', [
            $month
        ]));
    }
    ...
    {
        return new static(lang('Time.invalidDay', [
            $day
        ]));
    }
    ...
    {
        return new static(lang('Time.invalidOverDay', [
            $lastDay,
            $day
        ]));
    }
    ...
    {
        return new static(lang('Time.invalidHour', [
            $hour
        ]));
    }
    ...
    {
        return new static(lang('Time.invalidMinutes', [
            $minutes
        ]));
    }
    ...
    {
        return new static(lang('Time.invalidSeconds', [
            $seconds
        ]));
    }
}
