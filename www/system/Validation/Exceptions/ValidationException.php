...
class ValidationException extends FrameworkException implements ExceptionInterface
{
    ...
    {
        return new static(lang('Validation.ruleNotFound', [
            $rule
        ]));
    }
    ...
    {
        return new static(lang('Validation.groupNotFound', [
            $group
        ]));
    }
    ...
    {
        return new static(lang('Validation.groupNotArray', [
            $group
        ]));
    }
    ...
    {
        return new static(lang('Validation.invalidTemplate', [
            $template
        ]));
    }
