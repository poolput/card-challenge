...
class ViewException extends FrameworkException implements ExceptionInterface
{
    ...
    {
        return new static(lang('View.invalidCellMethod', [
            'class' => $class,
            'method' => $method
        ]));
    }
    ...
    {
        return new static(lang('View.missingCellParameters', [
            'class' => $class,
            'method' => $method
        ]));
    }
    ...
    {
        return new static(lang('View.invalidCellParameter', [
            $key
        ]));
    }
    ...
    {
        return new static(lang('View.invalidCellClass', [
            $class
        ]));
    }
    ...
    {
        return new static(lang('View.tagSyntaxError', [
            $output
        ]));
    }
}
