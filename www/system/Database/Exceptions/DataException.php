...
class DataException extends \RuntimeException implements ExceptionInterface
{
    ...
    {
        return new static(lang('Database.invalidEvent', [
            $method
        ]));
    }
    ...
    {
        return new static(lang('Database.emptyDataset', [
            $mode
        ]));
    }
    ...
    {
        return new static(lang('Database.invalidArgument', [
            $argument
        ]));
    }
    ...
    {
        return new static(lang('Database.invalidAllowedFields', [
            $model
        ]));
    }
    ...
    {
        return new static(lang('Database.tableNotFound', [
            $table
        ]));
    }
    ...
    {
        return new static(lang('Database.forEmptyInputGiven', [
            $argument
        ]));
    }
