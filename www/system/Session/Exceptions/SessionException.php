...
class SessionException extends FrameworkException implements ExceptionInterface
{
    ...
    {
        return new static(lang('Session.invalidSavePath', [
            $path
        ]));
    }
    ...
    {
        return new static(lang('Session.writeProtectedSavePath', [
            $path
        ]));
    }
    ...
    {
        return new static(lang('Session.invalidSavePathFormat', [
            $path
        ]));
    }
}
